      ...
      <div className="aspect-[16/9] w-full overflow-hidden bg-[#0a0a0a] relative rounded-t-2xl border-b border-white/5">
        ...
        <div className="absolute right-3.5 top-3.5 z-20">
          {story.isPaid && story.price > 0 ? (
            <span className="flex items-center gap-0.5 rounded-full bg-white/95 text-slate-950 px-3 py-1 text-xs font-black shadow-lg shadow-black/50 border border-white backdrop-blur-md font-sans">
              ₹{story.price}
            </span>
          ) : (
            <span className="flex items-center gap-1 rounded-full bg-white/95 text-emerald-700 border border-white px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider backdrop-blur-md shadow-md">
              FREE
            </span>
          )}
        </div>
