              ...
              <div className="space-y-4 rounded-2xl border border-white/10 bg-white/[0.03] p-5">
                ...
                {paymentConfig.upiId ? (
                  <div className="flex items-center justify-between rounded-xl border border-cyan-400/20 bg-cyan-950/30 px-4 py-3">
                    <span className="font-mono text-sm font-bold text-cyan-200 select-all">{paymentConfig.upiId}</span>
                    <button
                      type="button"
                      onClick={copyUpiId}
                      className="flex items-center gap-1.5 rounded-lg bg-cyan-400/20 px-3 py-1.5 text-xs font-bold text-cyan-300 hover:bg-cyan-400/30 transition"
                    >
                ...
                {paymentConfig.upiQrUrl && (
                  <div className="flex flex-col items-center justify-center p-3 rounded-xl border border-white/10 bg-white/5">
                    <img src={paymentConfig.upiQrUrl} alt="UPI Scanner QR" className="h-36 w-36 object-contain rounded-lg bg-white p-1" />
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/10 bg-white/5 px-3.5 py-2.5 text-xs text-white focus:border-cyan-400/40 focus:outline-none"
                    />
                  </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/10 bg-white/5 px-3.5 py-2.5 text-xs text-white focus:border-cyan-400/40 focus:outline-none font-mono"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-cyan-400/30 bg-cyan-950/30 px-3.5 py-2.5 text-xs font-mono font-bold text-cyan-200 focus:border-cyan-400 focus:outline-none placeholder-cyan-500/40"
                    />
                  </div>
                </div>
